...
- (void)createContentControls
{
    ...
    UIView *adView = [[UIView alloc] initWithFrame:CGRectMake(10, 230, ScreenWidth-20, 110)];
    ...
    UILabel *linkLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 350, 100, 40)];
    linkLabel.text = @"广告链接";
    linkLabel.font = [UIFont boldSystemFontOfSize:20];
    [self.view addSubview:linkLabel];
    
    self.linkTextField = [[UITextField alloc] initWithFrame:CGRectMake(10, 400, ScreenWidth-20, 60)];
    ...
    self.saveMessageBtn.frame = CGRectMake(10, 470, ScreenWidth-20, 50);
